                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="add">
                                ...
                                <br><br>
                                <form action="{{ url('admin/product/attributes/store/'.$products->id) }}" method="POST" id="productForm"
                                    ...
                                    @csrf
                                        <table id="table_field">
                                            ...
                                            <tr id="tb_row" class="row" style="margin-bottom: 10px;">
                                                <td class="col-4">
                                                    <input type="text" class="form-control" name="size[]" id="size" value="" required aria-describedby="selling_price"
                                                ...
                                                <td class="col-4">
                                                    <input type="text" class="form-control" name="qty[]" id="qty" value="" required aria-describedby="selling_price"
                                                           placeholder="Enter product size">
                                                    @error('qty')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <td class="col-4">
                                                    <input type="button" value="Add" name="add" id="add" class="btn btn-success"></td>
                                            </tr>
                                            </tbody>
                                        </table>
